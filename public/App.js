...
font-family: "Roboto", 'Open Sans';`,
  ...
  componentDidMount() {
    this.handleInputChange(null, null, this.state.input)
  }

  convert = (input, options) => render(parse(input), options)

  handleInputChange = (editor, data, input) => {
    let error = false
    let output
    try {
    ...
    return (
      <div {...styles.app}>
        ...
        <header {...styles.header}>
          <img height={110} src={CssImg} />
          <span {...styles.arrow}>→</span>
          <img height={110} src={JsImg} />
        </header>
          ...
          <div {...styles.column}>
            <div {...styles.output}>
              ...
              <div {...styles.copy}>
                <span
                  {...css(styles.copied, {
                    opacity: this.state.showCopied && 1,
                  })}
                >
                  Copied!
                </span>
